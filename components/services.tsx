...
export function Services() {
  const services = [
    ...
    {
      icon: <Sun className="h-10 w-10 text-brand-500" />,
    ...
    {
      icon: <Building2 className="h-10 w-10 text-brand-500" />,
    ...
    {
      icon: <Drill className="h-10 w-10 text-brand-500" />,
    ...
    {
      icon: <House className="h-10 w-10 text-brand-500" />,
